...
import { create, destroy, edit, index } from '@/routes/admin/campaigns';
...
const pendingDelete = ref<Campaign | null>(null);
...
<template>
    ...
    <div class="p-4">
        <div class="flex items-center justify-between gap-4">
            <h1 class="text-2xl font-bold text-foreground">Campaigns</h1>
        ...
        <div v-if="campaigns.data.length === 0" class="mt-10 text-center">
            ...
            <table class="w-full text-left text-sm">
                <thead class="border-b border-border bg-muted/50">
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-3 font-medium">Ends</th>
                        <th scope="col" class="px-4 py-3 font-medium">
        ...
        >
            <Link
                v-for="(link, linkIndex) in campaigns.links"
                :key="linkIndex"
                :href="link.url ?? '#'"
                :class="[
