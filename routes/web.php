...
Route::middleware(['auth', 'verified', EnsureTwoFactorEnabled::class])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('supporters', [AdminSupporterController::class, 'index'])->name('supporters.index');
        Route::get('supporters/export', [AdminSupporterController::class, 'export'])->name('supporters.export');
        Route::get('supporters/{supporter}', [AdminSupporterController::class, 'show'])->name('supporters.show');
        Route::get('supporters/{supporter}/edit', [AdminSupporterController::class, 'edit'])->name('supporters.edit');
        Route::put('supporters/{supporter}', [AdminSupporterController::class, 'update'])->name('supporters.update');
